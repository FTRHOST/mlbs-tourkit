...
std::string RankToString(int uiRankLevel, int iMythPoint) {
    if (uiRankLevel > 135) {
        if (iMythPoint >= 100) {
            return "Mythical Immortal: " + std::to_string(iMythPoint);
        } else if (iMythPoint >= 50) {
            return "Mythic Glory: " + std::to_string(iMythPoint);
        } else if (iMythPoint >= 25) {
            return "Mythical Honor: " + std::to_string(iMythPoint);
        }
    } else {
...
std::string SpellToString(int summonSkillId) {
    ...
    case 20190:
        ...
        break;
    default:
    strSpell += std::to_string(summonSkillId);
    }
    return strSpell;
}
